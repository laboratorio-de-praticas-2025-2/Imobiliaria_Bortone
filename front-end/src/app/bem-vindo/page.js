    ...
    <div>
        ...
        <Flex vertical align='center' gap="large" className='boas-vindas-content'>
            ...
            <Flex vertical className='login-form-container' gap="large" align='center'>
                <Button type="primary" htmlType="submit" className='login-button w-[100%]'>Criar uma conta</Button>
                <Button type="primary" htmlType="submit" className='login-sec-button w-[100%]'>Login</Button>
                <Flex gap={14}>

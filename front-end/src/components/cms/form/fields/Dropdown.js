  ...
  return (
      ...
      >
        <button
          ...
          className={`flex items-center w-fit custom-input justify-center !rounded-full bg-[#EEF0F9] px-8 py-2 !text-[var(--primary)] font-medium focus:outline-none cursor-pointer hover:bg-[#E0E3F1] transition-colors ${classname}`}
        >

...
export default function Filter() {
  ...
  return (
    ...
    <div className="rounded-2xl shadow-xl w-[700px] h-[130px] meu-card bg-white ">
            ...
            <div>
              ...
              >
                ...
                <div className=" text-xs text-[var(--primary)] mt-4 ">
                  Descubra de forma rápida o valor do imóvel que você deseja adquirir
                  ou o valor das parcelas que cabem no seu bolso. Preencha seus dados
                  e receba as melhores opções de planos de consórcio para conquistar
                  seu imóvel sem juros e sem burocracia.
                </div>
    </div>
    </div>
  );

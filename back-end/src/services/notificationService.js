...
//         const usuariosIds = [...new Set(recomendacoes.map(r => {
//     // Extrai usuario_id de diferentes estruturas do Sequelize
//     return r.dataValues?.usuario_id || r.usuario_id || r.get?.('usuario_id');
